export default {
  ...
  extension: {
    ...
    conditionsContent:
      'When using the expansion module for the first time, you must install a CA certificate randomly generated by Proxyee Down, click the install button below and press the system to confirm the installation. The program will detect whether the Proxyee Down CA certificate has been installed in the operating system before installation. If it detects the installation, it will prompt to delete the corresponding old CA certificate.',
    install: 'Install',
